...
/**
 * Class Vineyard contains  functions which iterate the file "person_wine_4.txt" and generate the final list of all wines allotement and  generate the  file with desired result.
 *
...
$vineyard->generateWineList("person_wine_4.txt");
